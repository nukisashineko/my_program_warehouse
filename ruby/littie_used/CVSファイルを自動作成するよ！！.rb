...
neko_index_path="./Dropbox/www.konekono-heya.com/syurui/index.html"
...
if elm['class'] =="spec"
# p "spec"
 array <<  elm.css("li").map{|e| e.to_html.gsub(/(<\/?li>|<br>)/,"<li>"=>"","<br>"=>",")}.join(',')
end
end
...
print neko_all.map{|neko| neko_more_info neko}.join(',')
end
